...
pub fn get_packet_id(data: Vec<u8>) -> u8 {
  // dont use binary stream for optimization
  data[0]
}
...
//   bin.write_u8(ServerToClientHandshakePacket::packet_id());
...
// #[napi]
// pub fn serialize_client_to_server_handshake(_handshake: ClientToServerHandshakePacket) -> Vec<u8> {
//   let mut bin = BinaryStream::new();

//   bin.write_u8(ClientToServerHandshakePacket::packet_id());

//   bin.data
// }

// #[napi]
// pub fn deserialize_client_to_server_handshake(data: Vec<u8>) -> ClientToServerHandshakePacket {
//   let mut bin = BinaryStream::from(data);
